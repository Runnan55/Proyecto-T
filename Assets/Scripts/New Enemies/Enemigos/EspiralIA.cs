...
public class EspiralIA : EnemyLife
{
    ...
    public int projectilesToShoot = 6; // N�mero fijo de proyectiles
    public GameObject projectilePrefab;
    public Transform shootingPoint;
    public float shootingInterval = 0.2f;
    public float attackCooldownTime = 1.5f; // Tiempo que el enemigo no podr� atacar despu�s de recibir da�o
    ...
    private IEnumerator FindPlayerWithDelay()
    {
        ...
        if (player == null) Debug.LogError("No se encontr� un objeto con la etiqueta 'Player'");
    }
    ...
    private void Update()
    {
        ...
        switch (currentState)
        {
            ...
            case EnemyState.Stunned:
                // No hacer nada mientras est� aturdido.
                break;
        }
    ...
    private IEnumerator WaitAndShoot()
    {
        ...
        {
            Debug.LogError("ProjectilePrefab no est� asignado o ha sido destruido.");
            yield break; // Salir si no hay prefab
        }

        // Disparar el n�mero fijo de proyectiles
        for (int i = 0; i < projectilesToShoot; i++)
        {
            ...
            {
                Debug.LogError("ShootingPoint no est� asignado.");
            }
    ...
    private void TeleportAroundPlayer()
    {
        ...
        if (teleportMarkerPrefab != null)
        {
            ...
            Destroy(marker, 1f); // Eliminar el marcador despu�s de un segundo
        }
    ...
    private void LookAtPlayer()
    {
        if (player != null)
        {
            ...
            direction.y = 0; // Mantener la rotaci�n en el plano horizontal
